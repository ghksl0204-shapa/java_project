...
public class NateWeptoon {
	...
	public NateWeptoon(String title, String author) {
		super();
		this.title = title;
		this.author = author;
	}
	 ...
	 * annotation 이 존재하지 않더라도 오버라이딩을 구현하는 것에는 문제가 없음
	...
	public String toString() {
		return "NateWeptoon [title=" + title + ", author=" + author + "]";
	}
