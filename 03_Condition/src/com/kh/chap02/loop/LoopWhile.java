...
public class LoopWhile {
	 ...
	 * }
	 * 
	 * while문의 조건식의 결과값이 true일 경우 반복적으로 실행하고자 하는 코드를 싱행
	 * 
	 * for -> 개발자가 반복을 몇 번 해야할지 명확하게 알고 있다.
	 * while -> 개발자가 반복을 몇 번 해야할지 가늠할 수 가 없다.
	 * 
	 * 무한반복하는 용도로 while을 사용할 예정
	 */
	...
	public void method3() {
		...
		// 1부터 시작해서
		// 1~10사이의 임의의 정수까지를 모두 더한 합계를 출력
		// random : 무작위
		// Random이라는 클래스가 존재하지만
		// Math라는 클래스가 가지고 있는 random()을 호출해서 만들어 볼 예정
		
		// double number = Math.random(); //**추후확인**
		// System.out.println(number);
		// random()의 결과값은 : 0.0 ~~~ 0.9999999999999999 16자리
		// number에다가 10을 곱하면??
		// 0.0 ~~~ 9.9999999999999
		...
		// 10을 곱한결과를 int형으로 강제형변환을 해준 뒤 정수값 1을 더함
