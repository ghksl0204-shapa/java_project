...
public class Run {
	...
	public static void main(String[] args) {
		...
		// 2. 요소를 수정하는 메소드
		// set(int index, E e) : List 의 index 위치에 값을 전달한 요소(e)로 set 해주는 메소드
		plants.set(0, "시이이이이이이이작");
		System.out.println(plants);
		...
		// plants.remove(5);
		System.out.println(plants);
		// IndexOutOfBoundException == index 값을 잘 고려해서 인자값을 전달해야함
		...
		// 4. 리스트의 크기를 반환받기
		// size() : 리스크에 담겨있는 요소의 개수
		System.out.println(plants.size());
		
		// 5. List 의 해당 index 위치에 담긴 요소를 반환받는 메소드
		// get(int index) : E
