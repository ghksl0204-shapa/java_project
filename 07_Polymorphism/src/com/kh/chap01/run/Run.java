...
public class Run {
	...
	public static void main(String[] args) {
		...
		// 부모클래스인 Parent 가 자식클래스인 Child1에게 자료형을 상속해 주었기 때문에
		// Child1객체가 Parent 타입으로 형변환을 수행해서 대입됨
		// Parent p3 = (Parent)new Test();
		p2.printParent();
		// p2.printChild1();
		// p2로는 Parent 타입 객체만 사용가능
		 ...
		 */
		/*
		// Child1 타입 객체 두 개, Child2 타입 객체 두 개
		...
		*/
		...
		for(int i = 0; i < arr.length; i++) {
			...
			*/
			 ...
			 * 			실직적으로 참조하는 객체가 해당 메소드를 오버라이딩 했다면 <- 전제조건
